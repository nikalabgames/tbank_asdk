...
public extension Check3DSVersionPayload {
    ...
    func receiveVersion() -> ThreeDSVersion {
        let hasTdsServerTransID = tdsServerTransID?.isEmpty == false
        let hasThreeDSMethodURL = threeDSMethodURL?.isEmpty == false
        let hasPaymentSystem = paymentSystem?.isEmpty == false
