...
public enum FinishAuthorizeDataEnum {
    ...
    var additionalData: AdditionalData? {
        switch self {
        case let .dictionary(additionalData): return additionalData
        case let .threeDsBrowser(wrapper): return wrapper.additionalData
        case let .threeDsSdk(wrapper): return wrapper.additionalData
        }
    }
}
