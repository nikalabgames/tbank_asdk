...
### Тут находится Changelog для версий 3.1.1 и ниже.

### [Новый Changelog](./Changelog) разбит по компонентам.
...
* [EACQAPW-5853] Remove allure ids
* [EACQAPW-5770] Add card (checkType = NO) UI Test
* [EACQAPW-5888] Tests improvements
* [EACQAPW-5747] No autoimports plugin refactor
...
* [EACQAPW-5898] Gitlab ci pipelines
...
* [EACQAPW-5884] Extend receipt params
