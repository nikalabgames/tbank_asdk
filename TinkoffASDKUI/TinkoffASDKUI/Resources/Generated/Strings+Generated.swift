...
internal enum Loc {
  internal enum Acquiring {
    ...
    internal enum CardList {
      ...
      /// Удаляем карту %@
      internal static func deleteSnackBar(_ p1: Any) -> String {
        return Loc.tr("Localizable", "Acquiring.CardList.DeleteSnackBar", String(describing: p1), fallback: "Удаляем карту %@")
      }
      /// Ваши карты
    ...
    internal enum Common {
      ...
      /// Т-Банк
      internal static let tcsCardTitle = Loc.tr("Localizable", "Acquiring.Common.TcsCardTitle", fallback: "Т-Банк")
      /// Банк ВТБ
  ...
  internal enum CommonSheet {
    ...
    internal enum PaymentFailed {
      ...
      /// Попробуйте еще раз или оплатите другим способом
      internal static let tryAgain = Loc.tr("Localizable", "CommonSheet.PaymentFailed.TryAgain", fallback: "Попробуйте еще раз или оплатите другим способом")
    }
    internal enum PaymentForm {
      ...
      /// Чтобы узнать детали, свяжитесь с магазином
      internal static let contactStore = Loc.tr("Localizable", "CommonSheet.PaymentForm.ContactStore", fallback: "Чтобы узнать детали, свяжитесь с магазином")
      ...
      /// В приложении T-Банка
      internal static let tinkoffPayDescription = Loc.tr("Localizable", "CommonSheet.PaymentForm.TinkoffPayDescription", fallback: "В приложении T-Банка")
      /// Оплатить с
      internal static let tinkoffPayPrimaryButton = Loc.tr("Localizable", "CommonSheet.PaymentForm.TinkoffPayPrimaryButton", fallback: "Оплатить с")
      /// T-Pay
      internal static let tinkoffPayTitle = Loc.tr("Localizable", "CommonSheet.PaymentForm.TinkoffPayTitle", fallback: "T-Pay")
      /// К оплате
  ...
  internal enum CommonStub {
    ...
    internal enum NoNetwork {
      ...
      /// Проверьте доступ к интернету и попробуйте еще раз
      internal static let tryLater = Loc.tr("Localizable", "CommonStub.NoNetwork.TryLater", fallback: "Проверьте доступ к интернету и попробуйте еще раз")
    }
    internal enum SomeProblem {
      /// Понятно
      ...
      /// У нас проблема, мы уже ее решаем
      internal static let title = Loc.tr("Localizable", "CommonStub.SomeProblem.Title", fallback: "У нас проблема, мы уже ее решаем")
    }
  }
  internal enum Snackbar {
    internal enum AddCard {
      /// Такая карта уже привязана
      internal static let alreadyHasSuchCard = Loc.tr("Localizable", "Snackbar.AddCard.alreadyHasSuchCard", fallback: "Такая карта уже привязана")
      /// Не получилось добавить карту %@Попробуйте снова через пару минут
      internal static func problem(_ p1: Any) -> String {
        return Loc.tr("Localizable", "Snackbar.AddCard.problem", String(describing: p1), fallback: "Не получилось добавить карту %@Попробуйте снова через пару минут")
      }
    }
  }
  internal enum Tp {
  ...
  internal enum Action {
    /// Повторить
    internal static let `repeat` = Loc.tr("Localizable", "action.repeat", fallback: "Повторить")
  }
}
