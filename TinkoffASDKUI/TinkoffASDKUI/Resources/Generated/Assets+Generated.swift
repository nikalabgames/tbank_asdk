...
internal enum Asset {
  ...
  internal enum TinkoffPay {
    internal static let tinkoffPayAvatarBorder = ImageAsset(name: "tinkoffPay-avatar-border")
  ...
  internal enum Illustrations {
    ...
    internal static let alertRed = ImageAsset(name: "alert-red")
    ...
    internal static let redCross = ImageAsset(name: "red-cross")
    internal static let sandclock = ImageAsset(name: "sandclock")
    internal static let stopSign = ImageAsset(name: "stop-sign")
    internal static let wiFiOff = ImageAsset(name: "wi-fi-off")
  }
  internal enum Logo {
    internal static let bankLogo = ImageAsset(name: "bank_logo")
  }
