...
final class Button: UIView {
    ...
    var isEnabled: Bool {
        ...
        set {
            ...
            control.accessibilityTraits = newValue ? .none : .notEnabled
        }
    }
    ...
    private func setupAccessibility() {
        ...
        control.accessibilityIdentifier = AsdkAccessibilityIdentifier.buttonControl
        control.accessibilityTraits = isEnabled ? .none : .notEnabled
        accessibilityElements = [control, titleLabel]
    }
