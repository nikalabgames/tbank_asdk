...
extension CardFieldView {
    ...
    private func setupAccessibilityIdentifier() {
        cardNumberTextField.accessibilityIdentifier = AsdkAccessibilityIdentifier.cardNumberTextField
        expireTextField.accessibilityIdentifier = AsdkAccessibilityIdentifier.expireTextField
        cvcTextField.accessibilityIdentifier = AsdkAccessibilityIdentifier.cvcTextField
        dynamicCardView.accessibilityIdentifier = AsdkAccessibilityIdentifier.dynamicCardView
        scanButton.accessibilityIdentifier = AsdkAccessibilityIdentifier.addCardButton
    }
}
