...
extension CardPaymentViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case let .cardField(cellPresenter):
            ...
            cell.containedView.presenter = cellPresenter
            cell.insets = .cardCellsInsets
            cell.accessibilityIdentifier = AsdkAccessibilityIdentifier.payByNewCardPageCardData
            return cell
        ...
        case let .payButton(cellPresenter):
            ...
            cell.accessibilityIdentifier = AsdkAccessibilityIdentifier.payByNewCardPagePrimaryButton
            return cell
        }
    }
}
...
extension CardPaymentViewController {
    ...
    private func setupTableView() {
        ...
        tableView.accessibilityIdentifier = AsdkAccessibilityIdentifier.cardPaymentView
    }
}
