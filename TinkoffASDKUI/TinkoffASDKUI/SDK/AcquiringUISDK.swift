...
public final class AcquiringUISDK {
    ...
    /// Обеспечивает доступ к сетевым запросам и core бизнес логике
    public let coreSDK: AcquiringSdk

    /// Предоставляет доступ к SwiftUI интерфейсу
    public private(set) lazy var sui: IAcquiringSuiSDK = AcquiringSwiftUIAdapter(adaptee: self)

    // MARK: Dependencies

    internal let mainFormAssembly: IMainFormAssembly
    internal let addNewCardAssembly: IAddNewCardAssembly
    internal let cardListAssembly: ICardListAssembly
    internal let sbpBanksAssembly: ISBPBanksAssembly
    internal let tinkoffPaySheetAssembly: ITinkoffPaySheetAssembly
    internal let sbpQrAssembly: ISBPQrAssembly
    ...
    init(
        ...
        AsdkVersionProvider.uiVersion = Version.versionString
        ...
        let tdsWrapperBuilder = TDSWrapperBuilder(
            ...
            tdsCustomizationBuilder: TDSCustomizationBuilder()
        )
        ...
        let errorHandlerAssembly = ErrorHandlerAssembly()
        let featureToggleServiceAssembly = FeatureToggleServiceAssembly()
        ...
        paymentControllerAssembly = PaymentControllerAssembly(
            ...
            uiSDKConfiguration: uiSDKConfiguration,
            tdsCertsManager: tdsCertsManager,
            featureToggleServiceAsssembly: featureToggleServiceAssembly
        )
        ...
        addCardControllerAssembly = AddCardControllerAssembly(
            ...
            appBasedFlowControllerAssembly: appBasedFlowAssembly,
            featureToggleServiceAssembly: featureToggleServiceAssembly,
    ...
    public func presentSBPBanksList(
        ...
        let module = sbpBanksAssembly.buildInitialModule(paymentFlow: paymentFlow, isPresentingOverMainForm: false, completion: completion)
